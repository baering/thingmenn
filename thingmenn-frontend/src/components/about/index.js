    ...
    return (
      <div className="fill">
        ...
        <div className="About">
          ...
          <p>Öll gögn eru sótt af vef Alþingis og skiptast þau niður í þrjá meginflokka: atkvæðaskrár, ræðuskrár og þingskjalalista.</p>
          <p>Gögnin eru sótt sjálfkrafa, hver einasta undirsíða fyrir alla þingmenn er skoðuð, þau flokkuð og skoðuð fyrir hvern þingmann.</p>
          <p>Eftir að hafa unnið úr þeim fyrir hvern þingmann eru upplýsingum safnað saman til þess að fá gögn fyrir þingflokkana.</p>
