...
from api.mps import get_mps_by_lthing, get_similar_mps_by_lthing
...
api.add_url_rule('/api/lthing/<int:lthing>/mps/<string:mp_id>/similar', 'get_similar_mps_by_lthing', get_similar_mps_by_lthing)
